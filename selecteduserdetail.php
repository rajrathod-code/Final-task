...
<?php
 include("navbar.php");
?>
    <div class="container" style="background-image: url(img/background3.jpeg); background-size: cover; height: 100vh; width: 100%; z-index: 0.8;">
        ...
        <?php
            ...
            if(!$run)
            {
                echo "ERRO7R:".$qry."<br>".mysqli_error($con);
            }
            $rows = mysqli_fetch_assoc($run);
        ?>
        <h2 class="text-center pt-4 " style="color: white;"> <b>Transfer</b> </h2>
        <hr>
        <form  method="post" name="tcredit" class="table-text"><br>
            <div>
            <table class="table table-hover table-sm table-striped table-condensed table-bordered border-primary">
            <thead class="table-dark">
                <tr>
                    <th class="text-center" style="color: white;"> <b>Id</b> </th>
                    <th class="text-center" style="color: white;"> <b>Name</b> </th>
                    <th class="text-center" style="color: white;"> <b>Email Id</b> </th>
                    <th class="text-center" style="color: white;"> <b>Balance</b> </th>
                </tr>
                </thead>
                <tbody>
                <tr>
        ...
        <br><br><br>
            ...
            ?>
                ...
                <div class="text-center">
                    <button class="btn mt-3" name="submit" type="submit" id="myBtn" style="border: 2px solid black; background-color: black; color: white; width: 30%; border-radius: 20px;">Trasfer</button>
                </div>
        </form>
    </div>
